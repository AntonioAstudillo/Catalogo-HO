               ...
               <div class="container-fluid">
                   ...
                   <div class="card shadow mb-4">
                       <div class="card-header py-3">
                           ...
                           <button class="btn btn-outline-success" type="button" data-toggle="modal" data-target="#modalRegistroMarca">Agregar Diámetro Exterior </button>
                       </div>
                       <div class="card-body">
 ...
 <div class="modal-dialog">
    <div class="modal-content">
       <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Editar Diámetro</h5>
      ...
      <div class="modal-body">
          <div class="container">
            <form id="formDiametrosE" method="post">
              ...
              <div class="row mt-3">
                <div class="col-12 col-md-12">
                  <label for="diametroE">Diámetro exterior</label>
...
<div id="modalRegistroMarca" class="modal fade bd-example-modal-lg p-5" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
 <div class="modal-dialog modal-lg">
    <div class="modal-content">
       <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Registrar Diámetro Producto</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
      </div>
          ...
          <div class="mb-2">
             <div class="border p-5 mb-2">
               ...
               <div class="row informaciónSecudaria">
                  <div class="col-12">
                       <label for="diametroR">Diámetro</label>
                      <input type="text" name="diametroR"  id="diametroR" class="form-control" value="" placeholder="Ingresa el diámetro exterior" >
                  </div>
               </div>
             </div>
          </div>
    ...
    <div class="modal-footer">
      <button id="btnRegistrarDiametro" type="button" class="btn btn-primary">Agregar Diámetro</button>
      <button  type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
    </div>
  </div>
</div>
